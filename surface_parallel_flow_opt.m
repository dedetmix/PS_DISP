function [ts]=surface_parallel_flow_opt(value_type,varargin)
...
%	clear n;
	...
	save('generate_3d_SF_opt.mat','dN_ts_new','-append');
        ...
        colNames = {'GLS_error','P_grup_1','P_grup_2','P_grup_3','P_grup_4','mse','std_error_dU','std_error_dE','std_error_dN'};
        rowNames = {'iteration'};
